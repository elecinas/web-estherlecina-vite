import type { Project } from "../types/galleries";
...
export const galleries: Project[] = [
  {
    ...
    translations: {
      ...
      en: {
        portfolioLabel: "Comic",
        title: "Erin. Memories of a mercenary",
        description: "The history of a Mercenary who can't work.",
        cardImage: {
          src: "/images/comic_136_erin.jpg",
          alt: "alt de la imagen",
        },
        links: [
          ...
          {
            href: "https://www.koukyouzen.com/2019/01/entrevista-esther-lecina.html",
            title: "Interview about the publication of Erin",
        ...
        pageContent: [
          {
            text: "English: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ut nisl at eros dapibus pretium. Sed vitae tortor tempor, posuere ipsum nec, placerat nibh. Sed congue nisl purus, et molestie ante placerat sed. Nunc sollicitudin, diam nec condimentum accumsan, erat erat congue lorem, ac eleifend.",
            images: [
              {
                src: "/images/comic_124_125_erin.jpg",
                legend: "You can see double page",
                alt: "Erin lay down in a crowded room of enemies",
              },
              {
                src: "/images/comic_136_erin.jpg",
                legend: "Single page",
                alt: "Erin runs towards a big black ball.",
              },
              {
                src: "/images/comic_180_erin.jpg",
                legend: "I don't remember",
                alt: "Some image",
              },
            ],
          },
          {
            text: "English: Quisque quis laoreet elit, volutpat sodales velit. Etiam eleifend nunc id convallis ultricies. Duis sodales sit amet nunc ac volutpat. Morbi ac consequat lorem. Nulla volutpat velit eget cursus ultrices. Quisque tincidunt nulla velit, eu aliquet odio ultrices in. Ut cursus non ligula ut efficitur. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Pellentesque lacinia ullamcorper malesuada. Nulla nunc dui, tincidunt.",
          },
        ],
      },
    },
  },
  {
    ...
    translations: {
      ...
      en: {
        portfolioLabel: "Illustration",
        title: "Illustrations for the book Las ideas de Raquel",
        description: "Illustrations done for two books about the youtuber Raquel",
        cardImage: {
          src: "/images/react.svg",
        ...
        links: [
          {
            href: "disseny-ideas-de-raquel",
            title: "Link to the Editorial shop",
            label: "Go to the illustrations",
            linkDirection: "internal",
          },
        ],
        pageContent: [
          {
            text: "English: Ut cursus non ligula ut efficitur. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Pellentesque lacinia ullamcorper malesuada. Nulla nunc dui, tincidunt.",
            images: [
              {
                src: "/images/react.svg",
                legend: "Legend",
          ...
          {
            text: "English: Sed eu dui urna. Phasellus convallis mattis enim pretium condimentum. Etiam at volutpat orci. Phasellus laoreet sem non velit venenatis dapibus. Donec tincidunt sollicitudin arcu id pellentesque. Mauris egestas augue et nibh gravida, at condimentum nunc pellentesque. Aenean molestie neque feugiat felis posuere, in bibendum mauris pretium. Donec vel diam pulvinar, aliquam mi eu, semper turpis. Praesent aliquet dictum sagittis. Pellentesque a justo pharetra, elementum dui vitae, faucibus sem. Nulla commodo aliquam dui, vel molestie libero luctus nec. Maecenas in molestie ex. Etiam venenatis porta.",
          },
        ],
      },
    },
  },
  {
    ...
    translations: {
      ...
      en: {
        portfolioLabel: "GraphicDesign",
        title: "Editorial design for the book Las ideas de Raquel",
        description:
          "The design of the cover and  inside the books of the youtuber Raquel",
        cardImage: {
          src: "/images/react.svg",
          alt: "alt of the image",
        },
        links: [
          {
            href: "ilutracion-ideas-de-raquel",
            title: "Link to the Editorial shop",
            label: "Go to the Editorial Design process",
            linkDirection: "internal",
          },
        ],
        pageContent: [
            ...
            embeds: [
              {
                type: "youtube",
                src: "https://www.youtube.com/embed/FjXtccVky6M?si=Ei1xam2a1kmrVjXF",
                title: "Raquel sign books at Barcelona",
              },
              {
                type: "vimeo",
                src: "https://player.vimeo.com/video/1075753539?h=d3f9ad940d",
                title: "Project Arduino 1: authomatic water",
              },
              {
                type: "figma",
                src: "https://embed.figma.com/design/ZQlMkpqRKZiYJnJYKQlgij/Ca-La-Mariona?node-id=11-70&embed-host=share",
          ...
          {
            text: "EnglishSed eu dui urna. Phasellus convallis mattis enim pretium condimentum. Etiam at volutpat orci. Phasellus laoreet sem non velit venenatis dapibus. Donec tincidunt sollicitudin arcu id pellentesque. Mauris egestas augue et nibh gravida, at condimentum nunc pellentesque. Aenean molestie neque feugiat felis posuere, in bibendum mauris pretium. Donec vel diam pulvinar, aliquam mi eu, semper turpis. Praesent aliquet dictum sagittis. Pellentesque a justo pharetra, elementum dui vitae, faucibus sem. Nulla commodo aliquam dui, vel molestie libero luctus nec. Maecenas in molestie ex. Etiam venenatis porta.",
          },
        ],
      },
    },
