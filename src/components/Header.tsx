  ...
  return (
    <header>
      <div className="nav-menu-container">
        <NavLink to="/">
          <div className="logo">
            <img src={elsImago} width={40} height={40} alt="imagotipo de ELW" />
            <p className="els">
      ...
      >
        ...
        <select className="language-selector" value={language} onChange={(e) => languageSelector(e)}>
